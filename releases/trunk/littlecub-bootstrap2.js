...
function program3(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\" class=\"control-group form-horizontal\">\n                ";
...
function program1(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\"><i class=\"icon-info-sign\"></i> ";
  if (stack1 = helpers.helper) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.helper); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "</span>\n        ";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "-add\" class=\"lc-array-item-add btn btn-small\"><i class=\"icon-plus\"></i></button>\n                <button type=\"button\" data-lcid=\"";
  if (stack1 = helpers.id) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.id); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "-remove\" class=\"lc-array-item-remove btn btn-small\"><i class=\"icon-remove\"></i></button>\n            </div>\n        </div>";
  return buffer;
  }));
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "-array-toolbar-add\" class=\"lc-array-add btn btn-small\"><i class=\"icon-plus\"></i> Add</button>\n        </div>";
  return buffer;
  }));
...
function program6(depth0,data,depth1) {
  ...
  var buffer = "", stack1, stack2, options;
  buffer += "\n                <div>\n                    ";
  options = {hash:{},inverse:self.noop,fn:self.programWithDepth(7, program7, data, depth0, depth1),data:data};
...
function program7(depth0,data,depth1,depth2) {
  ...
  var buffer = "", stack1, stack2, options;
  buffer += "\n                    <div class=\"row";
  stack1 = helpers['if'].call(depth0, (depth1 && depth1.fluid), {hash:{},inverse:self.noop,fn:self.program(8, program8, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\">\n                        ";
  options = {hash:{},inverse:self.noop,fn:self.programWithDepth(10, program10, data, depth0, depth2),data:data};
  stack2 = ((stack1 = helpers.key_value || (depth0 && depth0.key_value)),stack1 ? stack1.call(depth0, (depth0 && depth0.value), options) : helperMissing.call(depth0, "key_value", (depth0 && depth0.value), options));
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n                    </div>\n                    ";
  return buffer;
...
function program10(depth0,data,depth1,depth3) {
  ...
  buffer += escapeExpression(stack2)
    + "\">\n                                ";
  stack2 = helpers.each.call(depth0, ((stack1 = (depth0 && depth0.value)),stack1 == null || stack1 === false ? stack1 : stack1.controls), {hash:{},inverse:self.noop,fn:self.programWithDepth(11, program11, data, depth3),data:data});
  if(stack2 || stack2 === 0) { buffer += stack2; }
  buffer += "\n                            </div>\n                        ";
  return buffer;
  }
...
function program13(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\" ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.fieldClass), {hash:{},inverse:self.program(7, program7, data),fn:self.program(5, program5, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += " ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.readonly), {hash:{},inverse:self.noop,fn:self.program(9, program9, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.placeholder), {hash:{},inverse:self.noop,fn:self.program(11, program11, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += " ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.size), {hash:{},inverse:self.noop,fn:self.program(13, program13, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "/>";
  return buffer;
  }));
